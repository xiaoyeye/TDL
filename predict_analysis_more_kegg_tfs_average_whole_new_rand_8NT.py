...
for test_indel in range(1,4):
    ...
    y_testyz = np.load('/home/yey3/nn_project2/data/hesc_2_GSE75748_firstone/TF_target_prediction/program2/seperation/conv_lstm/'+str(test_indel)+'new_Xlr00005_KEGG_3d_conv_ddeeper_NT_p600_e100' + '/end_y_test.npy')	
